...
QUERIES: List[Dict[str, Any]] = [
    ...
    # ── Brand Exclusion — Q1 exam scenarios ──────────────────────────────────
    {
        "id": 44,
        "group": "brand_exclusion",
        "label": "Q1-S1: 'no mac' — Apple must be excluded",
        "message": "I want a laptop, no mac",
        "expect_domain": "laptops",
        "expect_filters": ["excluded_brands"],
        "must_not_contain_brands": ["Apple", "apple", "MacBook", "macbook"],
        "expect_recs_on_first": True,
        "check_brand_exclusion": True,
    },
    {
        "id": 45,
        "group": "brand_exclusion",
        "label": "Q1-S2: 'hate ASUS' — ASUS must be excluded",
    ...
    },
    {
        "id": 46,
        "group": "brand_exclusion",
        "label": "Q1-S3: 'steer clear of HP' — indirect exclusion",
        "message": "steer clear of HP, bad experience, find me a laptop under $800",
        "expect_domain": "laptops",
        "expect_filters": ["excluded_brands"],
    ...
    },
    {
        "id": 47,
        "group": "brand_exclusion",
        "label": "Q1-S4: 'don't want 14 inch' — negated spec",
        "message": "I don't want a 14 inch screen laptop, show me options",
        "expect_domain": "laptops",
        "expect_filters": [],
        "must_not_contain_brands": [],
        "expect_recs_on_first": True,
    },
    {
        "id": 48,
        "group": "brand_exclusion",
        "label": "Q1-S5: 'burned by Apple' — experiential exclusion",
        "message": "burned by Apple before, need a reliable laptop under $1000",
        "expect_domain": "laptops",
        "expect_filters": ["excluded_brands", "budget"],
        "must_not_contain_brands": ["Apple", "apple", "MacBook"],
        "expect_recs_on_first": True,
        "check_brand_exclusion": True,
    },
    # ── Time / Urgency ───────────────────────────────────────────────────────
